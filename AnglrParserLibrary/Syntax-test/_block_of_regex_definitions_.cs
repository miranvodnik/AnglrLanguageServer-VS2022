		...
		public _block_of_regex_definitions_ (_block_of_regex_definitions_ p__block_of_regex_definitions_) : base (p__block_of_regex_definitions_.id, p__block_of_regex_definitions_.kind)
		{
			...
			switch ((production_kind) p__block_of_regex_definitions_.kind)
			{
				case production_kind.g__block_of_regex_definitions__1:
					children = (SyntaxTreeBase []) Array.CreateInstance (typeof (SyntaxTreeBase), 4);
					if ((children [0] = m__regex_ = (p__block_of_regex_definitions_.m__regex_ != null) ? new SyntaxTreeToken (p__block_of_regex_definitions_.m__regex_) : null) != null) m__regex_.parent = this;
					if ((children [1] = m__left_curly_bracket_ = (p__block_of_regex_definitions_.m__left_curly_bracket_ != null) ? new SyntaxTreeToken (p__block_of_regex_definitions_.m__left_curly_bracket_) : null) != null) m__left_curly_bracket_.parent = this;
					if ((children [2] = m__block_regex_definitions_optional_ = (p__block_of_regex_definitions_.m__block_regex_definitions_optional_ != null) ? new _block_regex_definitions_optional_ (p__block_of_regex_definitions_.m__block_regex_definitions_optional_) : null) != null) m__block_regex_definitions_optional_.parent = this;
					if ((children [3] = m__right_curly_bracket_ = (p__block_of_regex_definitions_.m__right_curly_bracket_ != null) ? new SyntaxTreeToken (p__block_of_regex_definitions_.m__right_curly_bracket_) : null) != null) m__right_curly_bracket_.parent = this;
					break;
				default:
				{
