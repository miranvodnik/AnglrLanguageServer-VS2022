...
{
	internal class RegexBlockPartRegex : Regex, RegexInterface
	{
		public RegexBlockPartRegex (LexerBase scanner) : base (@"(?<g1>\/\*)|(?<g2>\[\[)|(?<g3>\/\/[^\n]*)|(?<g4>[ \t]+)|(?<g5>.+)|(?<g6>[\n\r])", RegexOptions.ExplicitCapture)
		{
			Scanner = scanner;
		}

		public LexerBase Scanner { get; private set; }
		public static string Id { get; private set; } = "regex_block_part_ctx";

		public delegate int scannerCallback (RegexBlockPartRegex regex, LexerBase scanner);
