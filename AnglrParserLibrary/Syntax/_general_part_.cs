...
namespace Anglr.Parser
{
	...
	public class	_general_part_ : SyntaxTreeBase
	{
		...
		public _general_part_ (_general_part_ p__general_part_) : base (p__general_part_.id, p__general_part_.kind)
		{
			++g_counter;
			_init ();
			appInfo = p__general_part_.appInfo;
		...
		[DataMember (Name = "m__attribute_list_optional__1")] public _attribute_list_optional_ m__attribute_list_optional__1 { get; private set; }
		[DataMember (Name = "m__general_")] public SyntaxTreeToken m__general_ { get; private set; }
