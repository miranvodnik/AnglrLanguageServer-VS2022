...
namespace Anglr.Parser
{
	...
	public class	_anglr_file_ : SyntaxTreeBase
	{
		...
		public _anglr_file_ (_anglr_file_ p__anglr_file_) : base (p__anglr_file_.id, p__anglr_file_.kind)
		{
			++g_counter;
			_init ();
			appInfo = p__anglr_file_.appInfo;
			switch ((production_kind) p__anglr_file_.kind)
			{
				...
				case production_kind.g__anglr_file__2:
					children = (SyntaxTreeBase []) Array.CreateInstance (typeof (SyntaxTreeBase), 1);
					if ((children [0] = m__anglr_file_part_list_ = (p__anglr_file_.m__anglr_file_part_list_ != null) ? new _anglr_file_part_list_ (p__anglr_file_.m__anglr_file_part_list_) : null) != null) m__anglr_file_part_list_.parent = this;
					break;
				default:
				{
