	...
	public class	_general_part_ : SyntaxTreeBase
	{
		...
		public _general_part_ (_general_part_ p__general_part_) : base (p__general_part_.id, p__general_part_.kind)
		{
			...
			case production_kind.g__general_part__1:
				children = (SyntaxTreeBase []) Array.CreateInstance (typeof (SyntaxTreeBase), 6);
				children[0] = m__attribute_list_optional_ = p__general_part_.m__attribute_list_optional_;
				children[1] = m__general_ = p__general_part_.m__general_;
				children[2] = m__identifier_ = p__general_part_.m__identifier_;
				children[3] = m__left_part_bracket_ = p__general_part_.m__left_part_bracket_;
				children[4] = m__attribute_list_optional__1 = p__general_part_.m__attribute_list_optional__1;
				children[5] = m__right_part_bracket_ = p__general_part_.m__right_part_bracket_;
				break;
			default:
