	...
	public class	_parser_part_ : SyntaxTreeBase
	{
		...
		public _parser_part_ (_parser_part_ p__parser_part_) : base (p__parser_part_.id, p__parser_part_.kind)
		{
			...
			case production_kind.g__parser_part__1:
				children = (SyntaxTreeBase []) Array.CreateInstance (typeof (SyntaxTreeBase), 6);
				children[0] = m__attribute_list_optional_ = p__parser_part_.m__attribute_list_optional_;
				children[1] = m__parser_ = p__parser_part_.m__parser_;
				children[2] = m__identifier_ = p__parser_part_.m__identifier_;
				children[3] = m__left_part_bracket_ = p__parser_part_.m__left_part_bracket_;
				children[4] = m__anglr_syntax_rule_list_optional_ = p__parser_part_.m__anglr_syntax_rule_list_optional_;
				children[5] = m__right_part_bracket_ = p__parser_part_.m__right_part_bracket_;
				break;
			default:
