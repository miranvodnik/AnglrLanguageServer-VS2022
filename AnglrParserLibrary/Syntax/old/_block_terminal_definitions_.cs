...
namespace Anglr.Parser
{
	...
	public class	_block_terminal_definitions_ : SyntaxTreeBase
	{
		...
		public _block_terminal_definitions_ () { }
		...
		public _block_terminal_definitions_ (_block_terminal_definitions_ p__block_terminal_definitions_) : base (p__block_terminal_definitions_.id, p__block_terminal_definitions_.kind)
		{
			++g_counter;
			_init ();
			appInfo = p__block_terminal_definitions_.appInfo;
			switch ((production_kind) p__block_terminal_definitions_.kind)
			{
				case production_kind.g__block_terminal_definitions__1:
					children = (SyntaxTreeBase []) Array.CreateInstance (typeof (SyntaxTreeBase), 1);
					if ((children [0] = m__block_terminal_definition_ = (p__block_terminal_definitions_.m__block_terminal_definition_ != null) ? new _block_terminal_definition_ (p__block_terminal_definitions_.m__block_terminal_definition_) : null) != null) m__block_terminal_definition_.parent = this;
					break;
				case production_kind.g__block_terminal_definitions__2:
					children = (SyntaxTreeBase []) Array.CreateInstance (typeof (SyntaxTreeBase), 2);
					if ((children [0] = m__block_terminal_definitions_ = (p__block_terminal_definitions_.m__block_terminal_definitions_ != null) ? new _block_terminal_definitions_ (p__block_terminal_definitions_.m__block_terminal_definitions_) : null) != null) m__block_terminal_definitions_.parent = this;
					if ((children [1] = m__block_terminal_definition_ = (p__block_terminal_definitions_.m__block_terminal_definition_ != null) ? new _block_terminal_definition_ (p__block_terminal_definitions_.m__block_terminal_definition_) : null) != null) m__block_terminal_definition_.parent = this;
					break;
				default:
				{
