		...
		public _event_action_ (_event_action_ p__event_action_) : base (p__event_action_.id, p__event_action_.kind)
		{
			...
			switch ((production_kind) p__event_action_.kind)
			{
				case production_kind.g__event_action__1:
					children = (SyntaxTreeBase []) Array.CreateInstance (typeof (SyntaxTreeBase), 2);
					if ((children [0] = m__event_ = (p__event_action_.m__event_ != null) ? new SyntaxTreeToken (p__event_action_.m__event_) : null) != null) m__event_.parent = this;
					if ((children [1] = m__identifier_ = (p__event_action_.m__identifier_ != null) ? new SyntaxTreeToken (p__event_action_.m__identifier_) : null) != null) m__identifier_.parent = this;
					break;
				default:
				{
